class TranslationPrompts:
    DEEPSEEK_PROMPT = """
    Eres un traductor literario profesional. Traduce el siguiente texto del {source_language} al {target_language} manteniendo:
    ...
    OPENAI_PROMPT = """
    Como experto en traducción literaria, realiza una traducción del {source_language} al {target_language} que preserve:
